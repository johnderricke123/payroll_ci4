!(function (e, t, n, i) {
  ...
  (o.prototype.init = function () {
    ...
    var n,
      ...
      f = e(this.element);
    return u
      ? (console.warn("Plugin " + p + " is already initialized"), !1)
      : (f.prepend(
        ...
        (o = f[0].scrollHeight),
        (d = r.height()),
        o > d && (r.height(o), f.on("scroll", t).trigger("scroll")),
        this.options.text.length > 0 &&
          ($preloaderContainer.prepend(c),
    ...
    (e.fn[p] = function (t, n) {
      ...
      return f[i]
        ...
        : "object" != typeof i && i
        ? void e.error("Method " + i + " does not exist on jQuery." + p)
        : this.each(function () {
